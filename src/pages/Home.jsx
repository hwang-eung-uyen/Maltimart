  ...
  return (
    <Helmet title={"Home"}>
          ...
          <Row>
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <h2>Make Your Interior More Minimailistic $ Modern</h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Numquam corporis laborum cumque natus? Similique, excepturi
                  perferendis hic voluptate fugiat dicta.
                </p>
      ...
      <section className="timer__count">
        <Container>
          <Row>
            <Col lg="6" md="12" className="count__dow-col">
              <div className="clock__top-content">
                <h4 className="text-white fs-6 md-2">Limited Offer</h4>
